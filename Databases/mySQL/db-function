...
-- Task: Create a function to retrieve the total number of deliveries for a specific driver
DELIMITER !
...
SELECT numberOfDeliveries("Aggelidis") AS "The Total Number of Deliveries";
