...
CREATE INDEX secretary_firstName_idx 
ON secretary(firstName);

CREATE INDEX secretary_lastName_idx 
ON secretary(lastName);
...
CREATE INDEX client_firstName_idx
ON client(firstName);

CREATE INDEX client_lastName_idx
ON client(lastName);
...
CREATE INDEX driver_firstName_idx 
ON driver(firstName);

CREATE INDEX driver_lastName_idx 
ON driver(lastName);
